...
<style>
    ...
    header[data-testid="stAppHeader"] [data-testid^="stBaseButton"] {{
        background-color: {COLORS['surface']} !important;
    }}
    header[data-testid="stAppHeader"] [data-testid^="stBaseButton"] p,
    header[data-testid="stAppHeader"] [data-testid^="stBaseButton"] span {{
        color: {COLORS['text']} !important;
    }}
